...
import "./DoctorConsultation.css"; // Assuming you have a CSS file for styles
      ...
      <div className="home-section">
        ...
        <div className="home-text">
          ...
          <p ref={(el) => (textRefs.current[2] = el)} className="description">
            ...
            are. Whether you have a minor health concern, need a prescription
            refill, or require ongoing treatment for a chronic condition,
            DocOnCall makes it easy for you to get the care you need without
            having to visit a physical clinic. Our user-friendly platform is
            designed to make healthcare accessible and affordable for everyone,
            with secure video consultations, real-time chat, and easy scheduling
            options. With DocOnCall, you can be confident that you're receiving
            high-quality medical care from the comfort of your own home.
          </p>
          <button className="consult" onClick={() => navigate("/video-chat")}>
            Explore Now
          </button>
        </div>
      </div>
